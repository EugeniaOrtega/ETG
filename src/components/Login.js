                      ...
                      <div class="md:p-12 md:mx-6">
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          <div class="text-center pt-1 mb-12 pb-1">
                            ...
                            <p>O</p>
                            <div class="mt-5 mb-5 grid space-y-4 ">
                              <button
                              ...
                              >
                                <div class="relative flex items-center space-x-4 justify-center">
                                  <img
                                    ...
                                    alt="google logo"
                                  />
                                  <span class="text-white  block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">
                                    Entrar con Google
                                  </span>
                                </div>
                              </button>
                            </div>
                            <a class="text-gray-500" href="/resetPassword">
                              ¿Has olvidado la contraseña?
                            </a>
                          </div>
                          <div class="flex items-center justify-between pb-1 pt-1">
                            <p class="mb-0 mr-2">¿Aun no tienes cuenta?</p>
                            <a
                              href="/registro"
                              class="text-white group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100 login"
                              data-mdb-ripple="true"
