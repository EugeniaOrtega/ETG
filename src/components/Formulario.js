  ...
  return (
    <div className="w-full  bg-[url('/public/vessel.png')]">
      ...
      <div className=" w-full max-w-screen-xl mt-3 mx-auto">
        <Fade top>
          <div className="mx-auto max-w-7xl bg-blue-200 text-gray-700 ">
                ...
                <div className="order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6 ">
                  ...
                  >
                    <div className="lg:text-center">
                      <h1 className="mb-8 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                ...
                <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6 ">
                  <div className="mx-auto max-w-xl flex flex-col space-y-5">
                    ...
                    <p className="text-sm text-gray-500">
                      Nuestro equipo de atencion al cliente te contestara en la
                      medida de lo posible,lo antes posible.
                    </p>
                    {/* ::Email contact */}
                    <a
                      href="#mail"
